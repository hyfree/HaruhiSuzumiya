    ...
    public static class BearData
    {
        ...
        static BearData()
        {
            ...
            Bears.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Grosser_Panda.JPG/320px-Grosser_Panda.JPG"
            });
            ...
            Bears.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Teufelshöhle-Höhlenbär-Dreiviertelprofil.jpg/320px-Teufelshöhle-Höhlenbär-Dreiviertelprofil.jpg"
            });
