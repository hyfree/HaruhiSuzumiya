    ...
    public static class ElephantData
    {
        ...
        static ElephantData()
        {
            ...
            Elephants.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Elephas_skeleton.JPG/320px-Elephas_skeleton.JPG"
            });
            ...
            Elephants.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/f/f6/Mammuthus_exilis.jpg"
            });
        }
    }
}
