    ...
    public class AnimalsViewModel : INotifyPropertyChanged
    {
        ...
        void AddBears()
        {
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/0/08/01_Schwarzbär.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Ursus_thibetanus_3_%28Wroclaw_zoo%29.JPG/180px-Ursus_thibetanus_3_%28Wroclaw_zoo%29.JPG"
            });
            Animals.Add(new Animal
            {
                Name = "Brown Bear",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Kamchatka_Brown_Bear_near_Dvuhyurtochnoe_on_2015-07-23.jpg/320px-Kamchatka_Brown_Bear_near_Dvuhyurtochnoe_on_2015-07-23.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Grolar.JPG/276px-Grolar.JPG"
            });
            Animals.Add(new Animal
            {
                Name = "Sloth Bear",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Sloth_Bear_Washington_DC.JPG/320px-Sloth_Bear_Washington_DC.JPG"
            });
            Animals.Add(new Animal
            {
                Name = "Sun Bear",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Sitting_sun_bear.jpg/319px-Sitting_sun_bear.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Polar Bear",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/6/66/Polar_Bear_-_Alaska_%28cropped%29.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Spectacled_Bear_-_Houston_Zoo.jpg/264px-Spectacled_Bear_-_Houston_Zoo.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/ArctodusSimusSkeleton.jpg/320px-ArctodusSimusSkeleton.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/d/de/Monarch_the_bear.jpg"
            });
        }
        ...
        void AddCats()
        {
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Gustav_chocolate.jpg/168px-Gustav_chocolate.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Arabian Mau",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/d/d3/Bex_Arabian_Mau.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Bengal",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Paintedcats_Red_Star_standing.jpg/187px-Paintedcats_Red_Star_standing.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Burmese",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/0/04/Blissandlucky11.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Cyprus",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/CyprusShorthair.jpg/320px-CyprusShorthair.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "German Rex",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/c/c7/German_rex_harry_%28cropped%29.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Highlander",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Highlander-7.jpg/293px-Highlander-7.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Manx",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/en/9/9b/Manx_cat_by_Karen_Weaver.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Peterbald",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/c/c7/Peterbald_male_Shango_by_Irina_Polunina.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Scottish Fold",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Adult_Scottish_Fold.jpg/240px-Adult_Scottish_Fold.jpg"
            });
        }
        ...
        void AddDogs()
        {
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/6/69/Afghane.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Alpejski_gończy_krótkonożny_g99.jpg/320px-Alpejski_gończy_krótkonożny_g99.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/5/5e/American_Bulldog_600.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Bearded Collie",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/9/9c/Bearded_Collie_600.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Boston Terrier",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Boston-terrier-carlos-de.JPG/320px-Boston-terrier-carlos-de.JPG"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/7/79/Spoonsced.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Eurohound",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/9/98/Eurohound.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Irish Terrier",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/IrishTerrierSydenhamHillWoods.jpg/180px-IrishTerrierSydenhamHillWoods.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Kerry Beagle",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/7/75/Kerry_Beagle_from_1915.JPG"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/3/3b/Norwegian_Buhund_600.jpg"
            });
        }
        ...
        void AddElephants()
        {
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/African_Elephant_%28Loxodonta_africana%29_bull_%2831100819046%29.jpg/320px-African_Elephant_%28Loxodonta_africana%29_bull_%2831100819046%29.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/6/6a/African_Forest_Elephant.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Desert_elephants_in_the_Huab_River.jpg/320px-Desert_elephants_in_the_Huab_River.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Elephant_%40_kabini.jpg/180px-Elephant_%40_kabini.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Elephas_maximus_%28Bandipur%29.jpg/320px-Elephas_maximus_%28Bandipur%29.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Srilankan_tuskelephant.jpg/213px-Srilankan_tuskelephant.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Borobudur-Temple-Park_Elephant-cage-01.jpg/320px-Borobudur-Temple-Park_Elephant-cage-01.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Pygmy Elephant",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/9/93/Borneo-elephant-PLoS_Biology.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Mammoth",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Columbian_mammoth.JPG/320px-Columbian_mammoth.JPG"
            });
            Animals.Add(new Animal
            {
                Name = "Mastodon",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Mammut_americanum.jpg/320px-Mammut_americanum.jpg"
            });
        }
        ...
        void AddMonkeys()
        {
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Papio_anubis_%28Serengeti%2C_2009%29.jpg/200px-Papio_anubis_%28Serengeti%2C_2009%29.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Capuchin_Costa_Rica.jpg/200px-Capuchin_Costa_Rica.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Blue Monkey",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/BlueMonkey.jpg/220px-BlueMonkey.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Saimiri_sciureus-1_Luc_Viatour.jpg/220px-Saimiri_sciureus-1_Luc_Viatour.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Golden_lion_tamarin_portrait3.jpg/220px-Golden_lion_tamarin_portrait3.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Macaca_fuscata_fuscata1.jpg/220px-Macaca_fuscata_fuscata1.jpg"
            });
            Animals.Add(new Animal
            {
                Name = "Mandrill",
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/Mandrill_at_san_francisco_zoo.jpg/220px-Mandrill_at_san_francisco_zoo.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Proboscis_Monkey_in_Borneo.jpg/250px-Proboscis_Monkey_in_Borneo.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Portrait_of_a_Douc.jpg/159px-Portrait_of_a_Douc.jpg"
            });
            Animals.Add(new Animal
            {
                ...
                CoverImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Cuc.Phuong.Primate.Rehab.center.jpg/320px-Cuc.Phuong.Primate.Rehab.center.jpg"
            });
        }
